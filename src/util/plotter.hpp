...
class Plotter {
 public:
  ...
  void add_filled_rect(const Rect& rect, LineStyleId fill_style_id, LineStyleId border_style_id);
 ...
 private:
  ...
  std::vector<std::vector<Rect>> filled_rects_by_style_id_;
  std::vector<LineStyleId> filled_rect_border_styles_;
};
